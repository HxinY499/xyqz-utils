  ...
  return (
    <Route
      ...
      children={(routeProps: RouteChildrenProps) => {
        ...
        let match: boolean | null = !!routeMatch;
        ...
        if (props.shouldDestroyDomWhenNotMatch) {
          ...
          // 按正常逻辑
          if (props.render) {
            return match && props.render(routeProps as any);
          }
          return (
            match &&
            Component &&
            React.createElement(Component, routeProps as any)
          );
        } else {
          const matchStyle = {
            // 隐藏
          ...
          let component;
          if (props.render) {
            component = props.render(routeProps as any);
          } else {
